...
class Level:
    ...
    def __init__(self, map_data):
        ...
        self.ground_img = load_image(os.path.join('assets', 'ground.png'), size=(TILE_SIZE, TILE_SIZE), color=(111, 100, 88))
        self.platform_img = load_image(os.path.join('assets', 'platform.png'), size=(TILE_SIZE, TILE_SIZE), color=(150, 150, 150))
        self.flag_img = load_image(os.path.join('assets', 'flagpole.png'), size=(TILE_SIZE, TILE_SIZE * 2), color=(255, 255, 0))
