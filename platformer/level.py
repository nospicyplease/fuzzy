...
class Level:
    ...
    def __init__(self, map_data):
        ...
        self.ground_img = load_image('ground.png', (TILE_SIZE, TILE_SIZE), (139, 69, 19))
        self.platform_img = load_image('platform.png', (TILE_SIZE, TILE_SIZE), (150, 150, 150))
        self.flag_img = load_image('flagpole.png', (TILE_SIZE, TILE_SIZE * 2), (255, 255, 0))
